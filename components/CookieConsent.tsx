...
export default function CookieConsent() {
  ...
  <Cookie className="h-5 w-5 text-blue-600 inline-block" />
  We Value Your Privacy
</h3>
<p className="text-gray-600 text-xs sm:text-sm md:text-base leading-tight sm:leading-normal">
  OmniWTMS uses cookies to deliver essential site functionality, analyze usage, and personalize your experience. You can choose which cookies to allow, and change your preferences anytime. <span className="inline-block ml-1"><span className="bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs font-semibold">GDPR/UK/EU Compliant</span></span>
  <Link href="/privacy" className="text-blue-600 hover:underline inline-flex ml-2">
