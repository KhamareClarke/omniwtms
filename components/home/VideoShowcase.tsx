...
export default function VideoShowcase() {
  ...
  const integrations = [
    ...
    { name: 'Amazon', logo: '/integrations/amazon.png' },
    { name: 'eBay', logo: '/integrations/ebay.png' },
    { name: 'Etsy', logo: '/integrations/etsy.png' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-3 bg-blue-50 border border-blue-100 rounded-full px-3 py-1">
            ...
            <span className="text-sm font-medium text-blue-700">See it in action</span>
          </div>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
            Watch how OmniWTMS transforms your operations
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our 2-minute demo shows how you can track every delivery, manage inventory in real-time, 
            and eliminate paperwork from day one.
          </p>
        </div>
        ...
        <div className="max-w-4xl mx-auto relative bg-black/5 rounded-xl overflow-hidden shadow-2xl mb-10">
          {!videoPlaying ? (
            ...
            <div className="aspect-video relative group cursor-pointer" onClick={startVideo}>
              ...
              <div className="w-full h-full bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center">
                ...
                <span className="text-white/50 text-lg">OmniWTMS Product Demo</span>
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4 text-white hidden md:block">
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2">
              ...
              <div className="flex items-center gap-1">
                <CheckCircle className="w-4 h-4 text-green-400" />
                <span className="text-sm font-medium">Customer portal preview</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-8">
            {integrations.map((integration, i) => (
              <div 
                key={i}
                className="bg-white px-4 py-2 rounded-lg shadow-sm border border-gray-100 hover:shadow-md transition-shadow"
              >
                {/* If you have actual logo images, use this: */}
                {/* <Image src={integration.logo} alt={integration.name} width={100} height={40} /> */}
          ...
          <div className="text-center mt-4 text-sm text-gray-500">
            ...and many more popular e-commerce platforms and accounting services
          </div>
        </div>
      </div>
    </div>
