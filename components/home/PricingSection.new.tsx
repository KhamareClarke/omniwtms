              ...
              <div className="p-6">
                ...
                {index === 1 && (
                  <div className="bg-amber-50 border border-amber-200 rounded-md px-3 py-2 mb-4 text-sm">
                    ...
                    <span className="text-amber-800">Only 2 slots at this price!</span>
                  </div>
                )}
        ...
        <div className="mt-16 max-w-2xl mx-auto">
          <div className="bg-white rounded-xl border border-gray-200 shadow-md overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-gray-700 mb-6">Build your own plan starting at <strong>{customPlan.price}{customPlan.period}</strong></p>
