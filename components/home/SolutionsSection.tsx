      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mt-10">
          ...
          <button
            ...
            className="inline-flex items-center px-6 py-3 rounded-lg bg-blue-600 text-white font-bold text-lg shadow-md hover:bg-blue-700 transition-colors duration-200"
          >
