              ...
              <CardContent>
                <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <Input name="vehicle_size" value={truckForm.vehicle_size} onChange={handleTruckInput} autoComplete="off" className="border-gray-300 focus:border-[#3456FF] focus:ring focus:ring-[#3456FF]/10 font-sans transition-all" />
                  </div>
                  <div>
                    <label className="block text-xs font-medium mb-1 font-sans">Load Type</label>
                    <Input name="load_type" value={truckForm.load_type} onChange={handleTruckInput} autoComplete="off" className="border-gray-300 focus:border-[#3456FF] focus:ring focus:ring-[#3456FF]/10 font-sans transition-all" />
                  </div>
                  <div>
                  ...
                  <div className="md:col-span-2 flex justify-end">
                    <Button 
                      ...
                      className="bg-gradient-to-r from-[#3456FF] to-[#8763FF] hover:opacity-90 transition-all shadow-md font-medium w-full md:w-auto"
                    >
                      <div className="absolute inset-0 overflow-hidden rounded-md">
                        <div className="absolute top-0 -inset-full h-full w-1/2 z-5 block transform -skew-x-12 bg-gradient-to-r from-transparent to-white opacity-20 animate-shimmer" />
                      </div>
              ...
              <CardContent>
                <form className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end mb-4">
                  <div>
                    ...
                    <Input name="description" value={itemForm.description} onChange={handleItemInput} className="border-gray-300 focus:border-[#3456FF] focus:ring focus:ring-[#3456FF]/10 font-sans transition-all" />
                  </div>
                  <div>
                  ...
                  <Table className="min-w-full text-sm">
                    ...
                    <TableBody>
                      {items.map((item, idx) => (
                        <TableRow key={item.id} className={idx % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                          <TableCell>{item.description}</TableCell>
                          <TableCell><Input value={putawayForm[item.id]?.aisle || ''} onChange={e => handlePutawayInput(item.id, 'aisle', e.target.value)} className="border-gray-300 focus:border-[#3456FF] focus:ring focus:ring-[#3456FF]/10 font-sans transition-all" /></TableCell>
                          <TableCell><Input value={putawayForm[item.id]?.bay || ''} onChange={e => handlePutawayInput(item.id, 'bay', e.target.value)} className="border-gray-300 focus:border-[#3456FF] focus:ring focus:ring-[#3456FF]/10 font-sans transition-all" /></TableCell>
                          <TableCell><Input value={putawayForm[item.id]?.level || ''} onChange={e => handlePutawayInput(item.id, 'level', e.target.value)} className="border-gray-300 focus:border-[#3456FF] focus:ring focus:ring-[#3456FF]/10 font-sans transition-all" /></TableCell>
                          <TableCell><Input value={putawayForm[item.id]?.position || ''} onChange={e => handlePutawayInput(item.id, 'position', e.target.value)} className="border-gray-300 focus:border-[#3456FF] focus:ring focus:ring-[#3456FF]/10 font-sans transition-all" /></TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </Table>
            ...
            <Card className="glass-card border-gray-200 shadow-md">
              ...
              <CardContent>
                ...
                <div className="mt-4 flex flex-col md:flex-row gap-2 items-center justify-end">
                  ...
                  <Button disabled={!canFinishQuality || completing} onClick={async () => { setCompleting(true); await handleFinishQualityCheck(); setCompleting(false); }} className="bg-gradient-to-r from-[#3456FF] to-[#8763FF] hover:opacity-90 transition-all shadow-md font-medium">
