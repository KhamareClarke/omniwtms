...
export const WarehouseForm: React.FC<WarehouseFormProps> = ({ onSubmit, initialData, isLoading }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 w-full max-w-md mx-auto">
      ...
      <Button type="submit" className="w-full bg-gradient-to-r from-[#3456FF] to-[#8763FF] text-white" disabled={isLoading}>
