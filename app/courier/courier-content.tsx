      ...
      <div ref={labelRef} className="bg-white p-6 rounded-lg border">
        <div className="flex justify-between items-start">
          ...
          <Badge variant={
            ...
            delivery.priority === 'medium' ? 'warning' : 'secondary'
          }>
    ...
    try {
      ...
      if (newStatus === 'completed') {
        if (!delivery?.pod_file) {
          console.log('No POD file found, preventing completion');
                      ...
                      {delivery.status === 'pending' && (
                        <Button
                          ...
                          onClick={(e) => {
                            ...
                            e.preventDefault();
                            e.stopPropagation();
                            console.log('Starting delivery for ID:', delivery.id);
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm text-gray-500">
              {activeTab === 'dashboard' && 'Your latest delivery assignments and updates'}
              {activeTab === 'assigned' && 'Currently assigned and pending deliveries'}
          ...
          <div className="space-y-4">
            {renderDeliveryList(
              deliveries.filter(delivery => {
                switch (activeTab) {
                  case 'assigned':
                    return delivery.status === 'pending' || delivery.status === 'in_progress';
                  case 'completed':
