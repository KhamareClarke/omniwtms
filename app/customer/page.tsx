...
export default function CustomerDashboard() {
  ...
  return (
    <div className="flex min-h-screen">
      {/* Sidebar */}
      <aside className="w-64 min-h-screen bg-white border-r border-[#3456FF]/10">
        <div className="p-6">
          <h1 className="text-2xl font-bold bg-gradient-to-r from-[#3456FF] to-[#8763FF] bg-clip-text text-transparent"></h1>
          <p className="text-sm text-gray-500">Customer Portal</p>
        </div>
        <nav className="mt-6 px-4 space-y-2">
          <a href="#" className="flex items-center gap-2 p-3 rounded-lg text-gray-700 hover:bg-gradient-to-r hover:from-[#3456FF]/10 hover:to-[#8763FF]/10 hover:text-[#3456FF] transition-all">
          ...
          <a href="#" className="flex items-center gap-2 p-3 rounded-lg text-gray-700 hover:bg-gradient-to-r hover:from-[#3456FF]/10 hover:to-[#8763FF]/10 hover:text-[#3456FF] transition-all">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 2v4h-2V4H9v2H7V2a2 2 0 012-2h6a2 2 0 012 2zm-1 7a3 3 0 00-3-3H7a3 3 0 00-3 3v11a2 2 0 002 2h12a2 2 0 002-2V9z" /></svg>
            Labels
          </a>
          <a href="#" className="flex items-center gap-2 p-3 rounded-lg text-gray-700 hover:bg-gradient-to-r hover:from-[#3456FF]/10 hover:to-[#8763FF]/10 hover:text-[#3456FF] transition-all">
        ...
        <div className="absolute bottom-0 w-64 p-6 border-t border-[#3456FF]/10">
          <button onClick={handleLogout} className="w-full px-4 py-2 text-sm bg-gradient-to-r from-[#3456FF]/10 to-[#8763FF]/10 hover:from-[#3456FF]/20 hover:to-[#8763FF]/20 text-[#3456FF] rounded-lg transition-all">
            Logout
          </button>
        </div>
      </aside>
      ...
      <main className="flex-1 min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
        ...
        <header className="bg-white border-b border-[#3456FF]/10 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold bg-gradient-to-r from-[#3456FF] to-[#8763FF] bg-clip-text text-transparent">Dashboard Overview</h2>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="text-center text-xs text-gray-400 py-4">© 2023. All rights reserved.</div>
        </div>
      </main>
    </div>
  );
