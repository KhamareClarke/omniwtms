      ...
      <Card className="w-full max-w-md bg-white/10 backdrop-blur-lg border-white/20 shadow-xl">
        <CardHeader className="space-y-2">
          <CardTitle className="text-2xl sm:text-3xl font-heading font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
            {userType === 'client' ? 'Create Client Account' : 'Apply as Courier'}
          </CardTitle>
            ...
            <Form {...courierForm}>
              <form onSubmit={courierForm.handleSubmit(onCourierSubmit)} className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-400">Vehicle Type</FormLabel>
                      <div className="relative">
                        <Truck className="absolute left-3 top-2.5 h-5 w-5 text-gray-400" />
                        <FormControl>
                          <Input 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-400">Vehicle Registration</FormLabel>
                      <div className="relative">
                        <Truck className="absolute left-3 top-2.5 h-5 w-5 text-gray-400" />
                        <FormControl>
                          <Input 
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-gray-400">Preferred Region</FormLabel>
                      <div className="relative">
