...
import { Users, Smartphone, Mail, Lock, Plus, UserPlus, Search } from 'lucide-react';
    ...
    <AnimatedGradientBackground className="min-h-screen">
      ...
      <div className="container mx-auto p-4 space-y-8 relative">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1 font-sans">Add and manage your customers</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="glass-card border border-gray-200 shadow-sm rounded-xl p-4 relative overflow-hidden">
            ...
            <div className="flex justify-between items-start">
              <div>
                <p className="text-sm text-gray-500 font-sans">Total Customers</p>
                <p className="text-2xl font-semibold font-heading">{customers.length}</p>
              </div>
          ...
          <div className="glass-card border border-gray-200 shadow-sm rounded-xl p-4 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3">
              <div className="w-full">
                <p className="text-sm text-gray-500 font-sans mb-1">Search Customers</p>
          ...
          <Card className="glass-card border-gray-200 shadow-md lg:col-span-2 relative">
            ...
            <CardHeader>
              <CardTitle className="text-xl font-heading font-semibold flex items-center">
                ...
                <Badge className="ml-2 bg-[#3456FF]/10 text-[#3456FF] border-[#3456FF]/20">{filteredCustomers.length}</Badge>
              </CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <Table>
                  <TableHeader className="bg-gray-50/80 backdrop-blur-sm">
                    <TableRow>
                      ...
                      <TableHead className="font-semibold text-gray-700 font-heading">Contact Number</TableHead>
                      <TableHead className="font-semibold text-gray-700 font-heading">Email</TableHead>
                      <TableHead className="font-semibold text-gray-700 font-heading">Password</TableHead>
                    ...
                    {isLoading ? (
                      <TableRow>
                        <TableCell colSpan={5} className="text-center py-8">
                          <div className="flex flex-col items-center justify-center py-10 space-y-4">
                            ...
                            <p className="font-sans text-gray-500">Loading customers...</p>
                          </div>
                        </TableCell>
                      </TableRow>
                      ...
                      <TableRow>
                        <TableCell colSpan={5} className="text-center py-8">
                          <div className="flex flex-col items-center justify-center py-10 space-y-4">
                            ...
                            <p className="font-sans text-lg text-gray-600">{searchQuery ? 'No matching customers found' : 'No customers found'}</p>
                            <p className="font-sans text-sm text-gray-500 max-w-md text-center">
                              {searchQuery ? 'Try a different search term' : 'Add your first customer using the form'}
                            </p>
                          </div>
                        </TableCell>
                      </TableRow>
                      ...
                      filteredCustomers.map((c) => (
                        <TableRow key={c.id} className="hover:bg-gray-50/70 backdrop-blur-sm transition-colors">
                          ...
                          <TableCell className="font-mono text-sm">{c.contact_number}</TableCell>
