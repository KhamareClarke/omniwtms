            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="email" defaultValue="khamare@example.com" type="email" />
                </div>
                <div className="space-y-2">
        ...
        <TabsContent value="whitelabel" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload and customize your company logo</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure additional white label options</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="custom-domain" className="font-medium">Custom Domain</Label>
                    <p className="text-sm text-gray-500">Use your own domain for the platform</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="remove-branding" className="font-medium">Remove OmniDeploy Branding</Label>
                    <p className="text-sm text-gray-500">Hide all OmniDeploy branding elements</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="custom-email" className="font-medium">Custom Email Templates</Label>
                    <p className="text-sm text-gray-500">Use your own email templates</p>
                  </div>
